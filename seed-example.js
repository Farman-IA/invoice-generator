...
localStorage.setItem('issuer-profile', JSON.stringify({
...
localStorage.setItem('client-current', JSON.stringify({
...
localStorage.setItem('invoice-current', JSON.stringify({
  number: '2703202608',
